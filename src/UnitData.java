...
public enum UnitData {
    Wall(1, 0, new ImageIcon("wall.JPG"), 6, 0, 1, 0, 9),
    Archer(1, 1, new ImageIcon("archer.JPG"), 2, 5, 1, 0, 0),
    Swordsmen(1, 2, new ImageIcon("swordsmen.JPG"), 2, 8, 2, 0, 0),
    Wizard(1, 3, new ImageIcon("swordsmen.JPG"), 2, 12, 3, 0, 0),
    ;
    ...
    UnitData(int Faction, int UnitNumber, ImageIcon Image, int Defence, int Attack, int Delay, int Idle, int Extra) {
